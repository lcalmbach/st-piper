...
# boxes
p.vbar(cats, 0.7, q2.score, q3.score, fill_color="blue", fill_alpha=0.6, line_color="black")
p.vbar(cats, 0.7, q1.score, q2.score, fill_color="green",  fill_alpha=0.6, line_color="black")
